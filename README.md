...
- Facilita el trabajo en equipo mediante ramas para cada funcionalidad (`feature/`) y correccion de errores (`hotfix/`).
...
### Para features:
1. Crear rama desde `develop`: `git checkout -b feature/mejoras-codigo`
...
### Para hotfix:
1. Crear rama desde `main`: `git checkout -b hotfix-errorcodigo`
...
### Rol en CI/CD:
- **CI (Integración Continua):** Valida automáticamente cada cambio antes de integrarlo, evitando que código tenga errores.
